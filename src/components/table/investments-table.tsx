...
export const investmentColumns: ColumnDef<IInvestmentRequest>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            if (!type) return <div className="text-muted-foreground">Not specified</div>

            const typeMap = {
                INDIVIDUAL: { label: "Individual", variant: "outline" },
                COMPANY: { label: "Company", variant: "default" },
                HIGHNETWORTHINDIVIDUAL: { label: "HNW Individual", variant: "secondary" },
                SOPHISTICATEDINDIVIDUAL: { label: "Sophisticated", variant: "secondary" },
            }
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                            onClick={() => navigator.clipboard.writeText(investment._id ?? "")}
                        >
                            Copy ID
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
        ...
        <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                    ...
                    >
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="HIGHNETWORTHINDIVIDUAL">HNW Individual</SelectItem>
                            <SelectItem value="SOPHISTICATEDINDIVIDUAL">Sophisticated</SelectItem>
                        </SelectContent>
                    </Select>
                        ...
                        {isLoading ? (
                            ...
                            Array.from({ length: 5 }).map((_, index) => (
                                <TableRow key={`loading-${index}`}>
                                    {Array.from({ length: investmentColumns.length }).map((_, cellIndex) => (
                            ...
                            // Empty state
                            <TableRow>
                                <TableCell colSpan={investmentColumns.length} className="h-24 text-center">
                                    <div className="flex flex-col items-center justify-center gap-2 py-8">
                                        <p className="text-lg font-medium">No investment requests found</p>
            ...
            <div className="flex items-center justify-between">
                <div className="text-sm text-muted-foreground">
                    Showing {table.getRowModel().rows.length || 0} of {data.length} requests
                </div>
                <div className="flex items-center space-x-2">
                    <Button
                        variant="outline"
